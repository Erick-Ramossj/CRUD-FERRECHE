...
public class ConexionBD {
    private static final String URL = "jdbc:mysql://db-ferreche.chv0yevk6q3b.us-east-1.rds.amazonaws.com/ferreche";
    private static final String USER = "admin";
    private static final String PASSWORD = "fabrizio19";
